...
public class FileAppendProducer {
    ...
    public static void main(String[] args) {
        ...
        File file = new File("C:\\Users\\권세희\\Desktop\\sp1\\KafkaProj-01\\practice\\src\\main\\resources\\pizza_append.txt");
        EventHandler eventHandler = new FileEventHandler(kafkaProducer, topicName, sync);
        FileEventSource fileEventSource = new FileEventSource(500, file, eventHandler);
